...
{
    /// <summary>
    /// Логика взаимодействия для AddChildFileWindow.xaml
    /// </summary>
    public partial class AddChildFileWindow : Window
    {
        ...
        public AddChildFileWindow(string parentCaption)
        {
            InitializeComponent();

            tbParent.Text = parentCaption ?? string.Empty;
        ...
        // Метод для отмены добавления дочернего документа и закрытия окна
        ...
        // Метод для проверки введённых данных и подтверждения добавления дочернего документа
